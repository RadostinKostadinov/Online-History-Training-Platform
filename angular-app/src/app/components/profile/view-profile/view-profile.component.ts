...
export class ViewProfileComponent implements OnInit, OnDestroy {
  ...
  updateTable() {
    if (this.pageNumber * this.ptcsPerPage + this.ptcsPerPage > this.solvedPTCs.length) {
      this.ptcsToShow = this.solvedPTCs.slice(this.pageNumber * this.ptcsPerPage);
    } else {
      this.ptcsToShow = this.solvedPTCs.slice(this.pageNumber * this.ptcsPerPage, this.pageNumber * this.ptcsPerPage + this.ptcsPerPage);
    }
  }
