...
router.get("/all/teachers", async (req, res) => {
  try {
    const teachers = await User.find({ type: "teacher" }).lean();
...
router.patch("/update/:userId", validateUser, async (req, res) => {
  try {
